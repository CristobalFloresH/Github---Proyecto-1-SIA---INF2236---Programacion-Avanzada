...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        persona persona1 = new persona("Cristobal", "123456789-0", 25000);
        persona persona2 = new persona("Diego", "987654321-0", 10000);
        persona persona3 = new persona("Mauri", "111222333-4", 2000);

        bus bus1 = new bus(30, "HP*DS*20", 1, 1);
        bus bus2 = new bus(45, "JK*TH*53", 2, 3);
        bus bus3 = new bus(20, "LM*TG*90", 3, 2);

        viaje viaje1 = new viaje(25, 10000, bus1.getPatente(), "El Quisco", "Santiago", "10:30", "13:00");
        viaje viaje2 = new viaje(40, 20000, bus2.getPatente(), "Santiago", "Quilpue", "08:30", "12:00");
        viaje viaje3 = new viaje(15,  5000, bus3.getPatente(), "El Tabo", "San Antonio", "07:30", "08:00");
        ...
        boolean compra1 = persona1.comprarPasaje(viaje1, busDeViaje1, 12, "2025-08-30");

        bus busDeViaje2 = empresaBuses.obtenerBusPorPatente(viaje2.getPatente());
        boolean compra2 = persona2.comprarPasaje(viaje2, busDeViaje2, 1);

        bus busDeViaje3 = empresaBuses.obtenerBusPorPatente(viaje3.getPatente());
        boolean compra3 = persona3.comprarPasaje(viaje3, busDeViaje3, 19, "2025-07-12");
