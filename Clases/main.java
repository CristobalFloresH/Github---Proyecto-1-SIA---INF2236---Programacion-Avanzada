...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        persona persona1 = new persona("Cristobal", "12345678-9", 35000);
        persona persona2 = new persona("Diego", "98765432-1", 10000);
        persona persona3 = new persona("Mauri", "11122233-4", 2000);

        busPremium bus1 = new busPremium(30, "HP*DS*20", 1, 1);
        busComun bus2 = new busComun(45, "JK*TH*53", 2, 3);
        busComun bus3 = new busComun(20, "LM*TG*90", 3, 2);

        viajeDirecto viaje1 = new viajeDirecto(25, 10000, 120000 ,bus1.getPatente(), "El Quisco", "Santiago", "10:30", "13:00");
        viajeNoDirecto viaje2 = new viajeNoDirecto(40, 2000, 250000, bus2.getPatente(), "Santiago", "Quilpue", "08:30", "12:00");
        viajeNoDirecto viaje3 = new viajeNoDirecto(15, 5000, 80000, bus3.getPatente(), "El Tabo", "San Antonio", "07:30", "08:00");
